    ...
    def get(self, request):
        ...
        if cart.total_items == 0:
            ...
            if request.headers.get('HX-Request'):
                return TemplateResponse(request, 'orders/empty_cart.html',
        ...
        if request.headers.get('HX-Request'):
            return TemplateResponse(request, 'orders/checkout_content.html', context=context)
        return redirect(request, 'orders/checkout.html', context=context)
